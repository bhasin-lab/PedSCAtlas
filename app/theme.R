# Logo: Grey Light (Edited by hmumme 6/27/22, original is on https://github.com/nik01010/dashboardthemes) ----------------------------------------------------------------------------
...
theme_grey_light <- shinyDashboardThemeDIY(
  ...
  ,primaryFontColor = "rgb(79,83,121)"
  ...
  ,headerButtonIconColor = "rgb(79,86,121)"
